        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductAddOnId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductAddOnsName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalAmouont = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouponRedemptions", x => new { x.CouponId, x.UserId, x.OrderId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CouponRedemptions_Orders_OrderId1",
                        column: x => x.OrderId1,
                        principalTable: "Orders",
                        principalColumn: "OrderId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DliveryStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAddOnMaps", x => new { x.ProductAddOnId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductAddOnMaps_ProductAddOns_ProductAddOnId",
                        column: x => x.ProductAddOnId,
                        principalTable: "ProductAddOns",
                        principalColumn: "ProductAddOnId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductAddOnMaps_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CartItemId = table.Column<int>(type: "int", nullable: false),
                    ProductAddOnId = table.Column<int>(type: "int", nullable: false),
                    ProductAddOnId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItemAddOns", x => new { x.CartItemId, x.ProductAddOnId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItemAddOns_ProductAddOns_ProductAddOnId",
                        column: x => x.ProductAddOnId,
                        principalTable: "ProductAddOns",
                        principalColumn: "ProductAddOnId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItemAddOns_ProductAddOns_ProductAddOnId1",
                        column: x => x.ProductAddOnId1,
                        principalTable: "ProductAddOns",
                        principalColumn: "ProductAddOnId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemAddOns", x => new { x.OrderItemId, x.ProductAddOnId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItemAddOns_ProductAddOns_ProductAddOnId1",
                        column: x => x.ProductAddOnId1,
                        principalTable: "ProductAddOns",
                        principalColumn: "ProductAddOnId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Identifier",
                table: "AspNetUsers",
                column: "Identifier",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemAddOns_ProductAddOnId",
                table: "CartItemAddOns",
                column: "ProductAddOnId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItemAddOns_ProductAddOnId1",
                table: "CartItemAddOns",
                column: "ProductAddOnId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CouponRedemptions_OrderId1",
                table: "CouponRedemptions",
                column: "OrderId1",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemAddOns_ProductAddOnId1",
                table: "OrderItemAddOns",
                column: "ProductAddOnId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAddOnMaps_ProductId",
                table: "ProductAddOnMaps",
                column: "ProductId");
